...
//
// WHY: Search Console is verified for pertsfoundry.com and nothing in the repo read it. There is no
...
// never echo the value. The only network traffic is an anonymous node fetch of the live sitemap
// and one unfollowed request per secondary domain, both skipped with --offline.
//
// USAGE:
...
import { displayPath } from './lib/shared/display-path.mjs';
